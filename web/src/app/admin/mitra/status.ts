...
/**
 * Merapikan alamat domisili mitra sebelum disimpan.
 *
 * Beda dengan alamat PENGAJUAN JADWAL (`lib/passport/status.ts`, wajib diisi
 * karena mitra harus datang ke sana), domisili mitra BOLEH kosong — data ini
 * boleh terisi menyusul. Karena itu fungsi ini hanya merapikan spasi, tidak
 * pernah menolak apa pun.
 */

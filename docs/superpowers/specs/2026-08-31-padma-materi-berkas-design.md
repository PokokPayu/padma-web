...
- **Batas 300 halaman terkopel ke `max_rows` PostgREST.** Reader pasien membaca halaman lewat embed, dan embed ikut dipotong `max_rows` (1000). Diuji empiris dengan materi 1200 halaman: hanya 1..1000 yang kembali, tanpa error. Batas 300 karena itu bukan angka bebas — menaikkannya melewati 1000 membuat pasien diam-diam kehilangan halaman akhir sebuah e-book, tanpa satu pun tanda. Menaikkannya menuntut embed diganti query berpaginasi lebih dulu.
